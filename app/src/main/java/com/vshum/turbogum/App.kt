...
//            .addMigration(MIGRATION_1_2)
    ...
    /***
     * Можно позволить Room выполнять деструктивные миграции, когда изменяю схему базы данных. Это означает, что при обновлении схемы базы данных существующие данные будут потеряны. Чтобы это сделать, можно использовать метод fallbackToDestructiveMigration
     */
